...
# Filtering dataframe to include only comments with hashtag and having topic as negative
filtered_df = spark.sql("SELECT * FROM Instagram_Comment WHERE hashtags != '' AND topic = 'negative'")
c_df = filtered_df \
