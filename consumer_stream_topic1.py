...
# Filtering dataframe to include only comments with hashtag and having topic as positive
filtered_df = spark.sql("SELECT * FROM Instagram_Comment WHERE hashtags != '' AND topic = 'positive'")
c_df = filtered_df \
